...
const Section2 = () => {
  const background = {
    backgroundImage:'linear-gradient( rgba(0, 0, 0, 0.4) , rgba(0, 0, 0, 0.8) ),url("https://images.unsplash.com/photo-1496065187959-7f07b8353c55?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fHRlY2h8ZW58MHx8MHx8fDA%3D") ',
      ...
      <section className="mt-4 p-2" style={background}>
        <div className="flex  items-center justify-between w-3/4 gap-2 p-1 mx-auto">
          <div className=" w-4/5 flex items-center ">
            <span className="px-2 py-1 bg-white text-sm font-semibold">
              TECHNOLOGY
            </span>
            <hr className=" w-full border-[2px] border-solid border-red-500 " />
          </div>
          <span className=" cursor-pointer px-1 py-1 bg-black text-red-500 ">
            View all
          </span>
        </div>

        <div className=" w-3/4 mx-auto  grid sm:grid-cols-2 lg:grid-cols-4 gap-2 mt-4">
